...
⚙️ Currently **building Ciel AI** — a self-evolving assistant inspired by *divine intelligence* (work in progress 🧠)  
🚀 Passionate about **AI, Deep Learning, and Human-Centered Design**  
...
- 🛒 **ShoppingCart** → E-commerce cart with discount and price logic  
- 🧠 **Ciel AI (WIP)** → Transformer-based self-evolving assistant prototype  
